...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { content: @datum.content, name: @datum.name, type: @datum.type } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { content: @datum.content, name: @datum.name, type: @datum.type } }
